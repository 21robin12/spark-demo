...
docker cp %~dp0\target\beampipeline-0.1.jar spark:/shared/
...
docker exec -it spark spark-submit --class com.beampipeline.MinimalWordCount --master spark://spark:7077 /shared/beampipeline-0.1.jar /shared/input.txt
